...
/**
 * Use Google Analytics MCP infrastructure to get June 2025 campaign bounce rates
 */
...
async function getJune2025CampaignBounceRates() {
  console.log('📅 Using Google Analytics MCP to get June 2025 campaign bounce rates...\n');
  ...
  try {
    ...
    console.log('🔍 Using MCP getTrafficSources for June 2025...');
    ...
    console.log('📊 Processing June 2025 campaign data...\n');
    ...
    try {
      ...
      console.log('Direct campaign query results:');
    ...
    if (campaigns.length === 0) {
      ...
      console.log('\n💡 Possible reasons:');
      console.log('   - No paid campaigns were running in June 2025');
      console.log('   - Data retention period may not include June 2025');
    ...
    console.log('\n🎯 Campaign Bounce Rates for June 2025:');
    ...
    console.log('\n📋 Summary of June 2025 Campaign Performance:');
    campaigns.forEach((campaign, index) => {
      console.log(`${index + 1}. ${campaign.campaign}: ${campaign.bounceRate}% bounce rate (${campaign.sessions} sessions)`);
    });
    
  } catch (error) {
    console.error('❌ Error using Google Analytics MCP for June 2025:', error.message);
    console.log('\n💡 Troubleshooting suggestions:');
    console.log('   - Verify GA4 property access and permissions');
    console.log('   - Check if June 2025 data is within retention period');
    console.log('   - Ensure proper authentication setup');
  }
}

// Run the MCP-based June 2025 analysis
getJune2025CampaignBounceRates().catch(console.error);